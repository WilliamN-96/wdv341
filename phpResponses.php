...
<body>
    ...
    <?php
        //if the user response = 1 display Frog car, if 2 display Dog card, if 3 display cat card.
    ...
    <?php 
        if($userResponse == 1)
            echo "<div>";
            echo "<img src='frog.jpg'>";
            echo "<p>This is my Frog!</p>";
            echo "</div>";
    ...
    ?>
    <?php 
       echo "<p>Not Cat Boooo!</p>"; }       //end of the false branch for cat
    ?>
</body>
</html>